...
public:
  ...
  void update_data_logger_info(const std::string& device_id, const std::string& firmware_version, const std::string& algorithm_version) {
    if (data_logger_) {
  ...
  void publishIntensityCloud(capture_Image_List_t* stream, int idx) {
    ...
    modifier.setPointCloud2Fields(6, "x", 1, sensor_msgs::PointField::FLOAT32, "y", 1, sensor_msgs::PointField::FLOAT32, "z", 1,
                                  sensor_msgs::PointField::FLOAT32, "intensity", 1, sensor_msgs::PointField::UINT8, "confidence", 1,
                                  sensor_msgs::PointField::UINT16, "offset_time", 1, sensor_msgs::PointField::FLOAT32);
    ...
    if (image.length == image.width * image.height * 3 / 2) {
...

      {
        ...
        if (m_undistort_map_init_success) {
          ...
          cam_info.k[0] = m_camera_params.fx;
          cam_info.k[1] = 0.0;
          cam_info.k[2] = m_camera_params.cx;
          cam_info.k[3] = 0.0;
          cam_info.k[4] = m_camera_params.fy;
          cam_info.k[5] = m_camera_params.cy;
          cam_info.k[6] = 0.0;
          cam_info.k[7] = 0.0;
          cam_info.k[8] = 1.0;
          ...
          cam_info.height = cv_undistorted_image.image.rows;
          cam_info.width  = cv_undistorted_image.image.cols;
          ...
          cam_info.p[0]  = m_camera_params.fx;
          cam_info.p[1]  = 0.0;
          cam_info.p[2]  = m_camera_params.cx;
          cam_info.p[3]  = 0.0;
          cam_info.p[4]  = 0.0;
          cam_info.p[5]  = m_camera_params.fy;
          cam_info.p[6]  = m_camera_params.cy;
          cam_info.p[7]  = 0.0;
          cam_info.p[8]  = 0.0;
          cam_info.p[9]  = 0.0;
          cam_info.p[10] = 1.0;
    ...
    switch (odom_type) {
      ...
      case OdometryType::STANDARD: {
        ...
        if (show_camerapose) {
          ...
          Eigen::Quaterniond R(msg.pose.pose.orientation.w, msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z);
          if (extrinsic_ok_) {
            P = P + R * t_ic_;
            R = R * R_ic_;
          }
...
#endif
      m_cam = std::make_unique<mini_vikit::PolynomialCamera>(
          m_camera_params.width, m_camera_params.height, m_camera_params.fx, m_camera_params.fy, m_camera_params.cx, m_camera_params.cy, m_camera_params.skew,
...
private:
  ...
  Eigen::Matrix4d    T_il_ = (Eigen::Matrix4d() << 1.0, 0.0, 0.0, 0.00347, 0.0, 1.0, 0.0, 0.03447, 0.0, 0.0, 1.0, 0.02174, 0.0, 0.0, 0.0, 1.0).finished();
  ...
  mrs_lib::PublisherHandler<nav_msgs::msg::Odometry> odom_highfreq_publisher_;
